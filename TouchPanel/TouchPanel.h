...
void DrawCross(uint16_t Xpos,uint16_t Ypos); // possiamo disegnare una croce --> serve per la calibrazione "devi toccare qui"
void TP_DrawPoint(uint16_t Xpos,uint16_t Ypos); // posso disegnare un punto
